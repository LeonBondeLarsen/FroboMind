...
class UIPlugin(Plugin):
    ...
    def __init__(self, context):
        rospy.loginfo("RSD Plugin init() method")
...
class WorkerThread(QtCore.QThread):
    ...
    def guiInit(self,context):
        ...
        ui_file = os.path.join(rospkg.RosPack().get_path('ishan_rsd_rqtplugin_ui', 'resource', 'FrobitGUI.ui')
        loadUi(ui_file, self._widget)
    
        self._widget.setObjectName('RSDUi')
    ...
    def startButtonClicked(self):
        print("RSD Start Button Clicked")  
